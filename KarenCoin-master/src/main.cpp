...
// Copyright (c) 2013 The KarenCoin developers
...
uint256 hashGenesisBlock("0x0000000ff7a0f39606267bed22b3bb4eaeea8ef207d2c10b9b44cc695242240f");
static const unsigned int timeGenesisBlock = 1479300000;
...
const string strMessageMagic = "KarenCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 20 * 60; // readjust difficulty once per hour
...
static const int YEARLY_POS_BLOCK_COUNT = 1440 * 365;

int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
     /* 1440 blocks/day , 3153600 blocks/year */
    int64 nSubsidy = 0 * COIN;
	if (nHeight == 1 ) 
    {
        nSubsidy = 450000000 * COIN;
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Nov 16, 2016. The KarenCoin release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xca45deffbefc75a8f0b585310959135cf93c7f5154357e3a6ebc84fb02e6ccf5"));
...
unsigned char pchMessageStart[4] = { 0x14, 0x10, 0x0b, 0x10 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KarenCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KarenCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("KarenCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("KarenCoin-miner");
    ...
    try { loop {
        ...
        printf("Running KarenCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("KarenCoinMiner terminated\n");
        throw;
    }
}
