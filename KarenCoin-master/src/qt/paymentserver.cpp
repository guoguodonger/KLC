...
const QString BITCOIN_IPC_PREFIX("KarenCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click KarenCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start KarenCoin: click-to-pay handler");
    else
...
{
    // clicking on KarenCoin: URLs creates FileOpen events on the Mac:
